...
| [mcp-calculix](https://github.com/Casys-AI/mcp-calculix) | FEA — Gmsh meshing plus CalculiX static, modal, buckling, creep and coupled thermo-mechanical solves on STEP files. Faces designated by bounding box, mm/N/MPa. | **Active**<br />![last commit](https://img.shields.io/github/last-commit/Casys-AI/mcp-calculix?style=flat-square&label=) |
...
| [mcp-dfm](https://github.com/Casys-AI/mcp-dfm) | FDM printability checks on STL — build envelope, overhang area, minimum wall thickness. Every result declares what it did not check. | **Active**<br />![last commit](https://img.shields.io/github/last-commit/Casys-AI/mcp-dfm?style=flat-square&label=) |
| [mcp-prusaslicer](https://github.com/Casys-AI/mcp-prusaslicer) | Print time and material from real PrusaSlicer G-code — caller-owned profiles, mass reported only when a density is supplied. | **Active**<br />![last commit](https://img.shields.io/github/last-commit/Casys-AI/mcp-prusaslicer?style=flat-square&label=) |
| [mcp-tolerance](https://github.com/Casys-AI/mcp-tolerance) | ISO 286-1 fits and 1D stack-ups from the normative formulas — clearance/transition/interference, worst-case and RSS. No binary underneath. | **Active**<br />![last commit](https://img.shields.io/github/last-commit/Casys-AI/mcp-tolerance?style=flat-square&label=) |
| [mcp-spice](https://github.com/Casys-AI/mcp-spice) | Circuit verification through ngspice batch — operating point and reduced transients. The server owns the .control block; caller netlists are circuit only. | **Active**<br />![last commit](https://img.shields.io/github/last-commit/Casys-AI/mcp-spice?style=flat-square&label=) |
